...
# ✅ Home route (Render ke liye)
@app.route("/")
def home():
    return "Bot is running!"

# ✅ Webhook Route (Telegram ke liye)
...
def fetch_youtube_data(message):
    try:
        ...
        # ✅ Batches of 20 Results (3-second gap)
        batch_size = 20
...
# ✅ Run Flask App (No Open Port Issue Fixed)
